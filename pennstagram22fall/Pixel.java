...
public class Pixel implements Comparable<Pixel> {
    ...
    //private fields containing value for r, g, and b
    private int r;
    ...
    public int distance(Pixel px) {
        if (px == null) {
            ...
            return Math.abs(this.r - px.getRed()) 
                + Math.abs(this.g - px.getGreen()) 
    ...
    public boolean sameRGB(Pixel px) {
        if (this.r != px.getRed()) {
            return false;
        } else if (this.g != px.getGreen()) {
            return false;
        } else if (this.b != px.getBlue()) {
            return false;
        }
        return true;
    }
